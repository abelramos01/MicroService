document.addEventListener('DOMContentLoaded', () => {
    ...
    const restaurantId = getQueryParam('restaurant'); // pega o ID do restaurante da URL
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        fetch('http://localhost:3000/dishes')
            ...
            .then(data => {
                ...
                // 🔽 filtra pratos pelo restaurantId, se ele existir
                const filteredDishes = restaurantId
                    ? data.filter(dish => dish.restaurant_id == restaurantId)
                    : data;
                ...
                tabsList.querySelectorAll('a').forEach(tab => {
                    tab.addEventListener('click', (e) => {
                        ...
                        tab.parentElement.classList.add('is-active'); // sestaca a aba clicada
            ...
            .catch(err => {
                // em caso de erro, esconde o loader e mostra a mensagem de erro
